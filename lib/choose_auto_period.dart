...
class ChooseAutoPeriodPage extends StatefulWidget {
  const ChooseAutoPeriodPage({super.key});

  @override
  State<ChooseAutoPeriodPage> createState() => _ChooseAutoPeriodPageState();
}

class _ChooseAutoPeriodPageState extends State<ChooseAutoPeriodPage> {
