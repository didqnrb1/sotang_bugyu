...
import 'package:sotong/already.dart';
import 'package:sotong/choose_auto_period.dart';
import 'package:sotong/choose_auto_ratio.dart';
...
import 'package:sotong/set_Duration.dart';
    ...
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        switch (settings.name) {
          ...
          case '/already':
            return MaterialPageRoute(
              builder: (context) => const AlreadyPage(), // 거의 다 왔어요 페이지
            );
          case '/chooseAutoRatio':
            return MaterialPageRoute(
              builder: (context) => const  ChooseAutoRatioPage(), // 자동 비율 선택 페이지
            );
          case '/chooseAutoPeriod':
            return MaterialPageRoute(builder: (context) => const ChooseAutoPeriodPage()
            );
          case '/':
            return MaterialPageRoute(builder: (context) => const HomePage());
          case '/choosePrice':
            return MaterialPageRoute(builder: (context) => const ChoosePricePage());
          case '/setDuration':
            return MaterialPageRoute(builder: (context) => const SetDurationPage());
          default:
            return null;
        }
      },
