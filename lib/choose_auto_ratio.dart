...
import 'choose_auto_period.dart';

class ChooseAutoRatioPage extends StatefulWidget {
  const ChooseAutoRatioPage({super.key});

  @override
  State<ChooseAutoRatioPage> createState() => _ChooseAutoRatioPageState();
}

class _ChooseAutoRatioPageState extends State<ChooseAutoRatioPage> {
  int selectedIndex = -1;
            ...
            GestureDetector(
              onTap: () {
                if (selectedIndex != -1) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ChooseAutoPeriodPage()),
                  );
                }
              },
              child: Container(
